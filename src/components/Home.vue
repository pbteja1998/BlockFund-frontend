...
<span>
  ...
  <div class="row">
    <div class="col-md-3 pointer mb-5" :key="project.id" v-for="project in projects" @click="$router.push({ name: 'project-view', params: {id: project.id} } )">
          <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="project-stats">
                    <span class="text-success">{{ project.amount }} BLC pledged</span><br>
                    <span>{{ ((project.amount*100)/project.total).toFixed(0) }}% funded</span><br>
                    <span>{{ project.remainingDays }} days to go</span><br>
